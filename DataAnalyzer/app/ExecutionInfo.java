...
public class ExecutionInfo {
    ...
    public ExecutionInfo(Map<String, Integer> fibMap, 
        ...
        this.executionTime = executionTime;
           ...
           // calculating the totalMethodCalls            
           totalMethodCalls = 0; 
           for (String keyset : keySet) {
               totalMethodCalls += fibMap.get(keyset);
           }
    ...
    public void displayInfo(){
        ...
        // using the keySet variable to loop throught all the keys for the output
         for(String key : keySet){
         System.out.printf("%-20s %-5d \t %-10.3f\n", key + ":" ,fibMap.get(key),
                 (fibMap.get(key)/ totalMethodCalls));
        } // printf format??
