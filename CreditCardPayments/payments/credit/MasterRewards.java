...
public class MasterRewards extends MasterCard {
    ...
    public MasterRewards(Person cardHolder, double creditLimit) {
        super(cardHolder, creditLimit); // keyword super, MasterCard class
    ...
    protected  void fees(){
        ...
        if(purchases.size() > 0 && purchases.size()%5 == 0){
            ...
            // super is used for the interest rate in MasterCard
            ...
            String message = "<" + dateStr + ">" +
                    String.format("  $%-5.2f fee charged", fee);
    ...
    public void makePurchase(Item item){
            ...
            if(item.getPrice() <= (creditLimit - balance)){
                ...
                // rewardsPoints is an int and getPrice returns a double so it is casted
